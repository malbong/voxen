...
Voxen은 마인크래프트에서 영감을 받은 복셀 오픈 월드 렌더링 프로젝트로, DirectX 11과 C++20으로 구축되었습니다. MSAA를 적용한 디퍼드 셰이딩, 캐스케이드 섀도우 매핑, SSAO, PBR 라이팅, 멀티스레드 청크 관리 기반의 실시간 월드 생성 등 고급 그래픽스 기술을 구현합니다.
...
- Visual Studio 2022에서 `voxen.sln`을 열고 빌드 (F5 또는 Ctrl+B)
